...
class LineChart1 extends StatelessWidget {
  ...
  LineChartBarData get lineChartBarData1_2 => LineChartBarData(
        ...
        belowBarData: BarAreaData(
          show: false,
          color: ColorManager.chartcolor1.withOpacity(0),
        ),
        spots: const [
          FlSpot(1, 1),
          FlSpot(3, 2.8),
  ...
  LineChartBarData get lineChartBarData2_1 => LineChartBarData(
        isCurved: true,
        curveSmoothness: 0,
        color: ColorManager.chartcolor2.withOpacity(0.5),
        barWidth: 4,
        isStrokeCapRound: true,
        dotData: const FlDotData(show: false),
        belowBarData: BarAreaData(show: false),
  ...
  LineChartBarData get lineChartBarData2_2 => LineChartBarData(
        isCurved: true,
        color: ColorManager.chartcolor1.withOpacity(0.5),
        barWidth: 4,
        isStrokeCapRound: true,
        dotData: const FlDotData(show: false),
        belowBarData: BarAreaData(
          show: true,
          color: ColorManager.chartcolor1.withOpacity(0.2),
        ),
        spots: const [
          FlSpot(1, 1),
          FlSpot(3, 2.8),
  ...
  LineChartBarData get lineChartBarData2_3 => LineChartBarData(
        isCurved: true,
        curveSmoothness: 0,
        color: ColorManager.chartcolor3.withOpacity(0.5),
        barWidth: 2,
        isStrokeCapRound: true,
