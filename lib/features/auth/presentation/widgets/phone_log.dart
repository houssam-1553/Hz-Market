...
class PhoneLogWidget extends StatefulWidget {
  @override
  _PhoneLogWidgetState createState() => _PhoneLogWidgetState();
}

class _PhoneLogWidgetState extends State<PhoneLogWidget> {
  TextEditingController _phoneTextController = TextEditingController();
...
Column buildLoginWithPhoneSection(BuildContext context) {
  return Column(
      children: [
         SizedBox(height: 30),
        FadeInUp(
...
if (isotp) {
 ...
 // Provider.of<AuthProvider>(context, listen: false).showPinCodeScreen = true ;
  ...
  Widget build(BuildContext context) {
    return buildLoginWithPhoneSection(context);
  } }
